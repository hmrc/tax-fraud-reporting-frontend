...
activity.name.borderCrime                  = Troseddau wrth y ffin
activity.name.offPayrollWorking            = Torri rheolau gweithio oddi ar y gyflogres (IR35)
activity.name.statutorySickPay             = Twyllo Tâl Salwch Statudol (SSP) neu’r Cynllun Ad-dalu Tâl Salwch Statudol
activity.name.constructionIndustryScheme   = Twyllo’r Cynllun Diwydiant Adeiladu
activity.name.eatOutToHelpOut              = Twyllo’r Cynllun Bwyta Allan i Helpu Allan.
activity.name.incomeSupport                = Twyllo’r Cynllun Cymhorthdal Incwm Hunangyflogaeth
activity.name.childBenefits                = Hawliadau Budd-dal Plant ffug
activity.name.taxCredit                    = Hawliadau Credyd Treth ffug
activity.name.vatRefund                    = Hawliadau Ad-daliadau TAW ffug
activity.name.brexit                       = Twyll yn ymwneud â Brexit
activity.name.charities                    = Twyll yn ymwneud ag elusennau
activity.name.furlough                     = Twyll yn ymwneud â ffyrlo
activity.name.importExport                 = Twyll yn ymwneud â mewnforio ac allforio
activity.name.selfAssessment               = Twyll yn ymwneud â Threth Incwm Hunanasesiad
activity.name.privateSecurity              = Twyll yn ymwneud â’r diwydiant diogelwch preifat
activity.name.vatRelated                   = Twyll yn ymwneud â TAW
activity.name.humanTrafficking             = Masnachu pobl
activity.name.illegalFlowOfMoney           = Llif arian anghyfreithlon
activity.name.immigration                  = Mewnfudiad anghyfreithlon
activity.name.redDiesel                    = Defnydd anghyfreithlon o ddiesel coch
activity.name.vatFreeImports               = Mewnforio nwyddau sy’n rhydd o TAW ac yna codi TAW ar gwsmeriaid
activity.name.employmentStatus             = Statws cyflogaeth anghywir
activity.name.landfillAndWaste             = Twyll Treth Tirlenwi/Gwastraff
activity.name.organisedCrime               = Ariannu sefydliadau troseddol
activity.name.laundering                   = Gwyngalchu arian
activity.name.minimumWage                  = Peidio â chael isafswm cyflog
activity.name.betting                      = Peidio â thalu toll betio
activity.name.capitalGains                 = Peidio â thalu Treth Enillion Cyfalaf
activity.name.alcohol                      = Peidio â thalu toll ar alcohol
activity.name.tobacco                      = Peidio â thalu toll ar dybaco
activity.name.inheritance                  = Peidio â thalu Treth Etifeddiant
activity.name.sugar                        = Peidio â thalu treth siwgr
activity.name.windingUpACompany            = Peidio â thalu treth wrth ddirwyn cwmni i ben
activity.name.selfEmployment               = Heb gofrestru fel person hunangyflogedig
activity.name.offShoreAccounts             = Cyfrifon banc alltraeth
activity.name.assets                       = Pobl â mwy na £2 filiwn o asedau sydd ddim yn talu treth
activity.name.smuggling                    = Smyglo
activity.name.cashDeposits                 = Adneuon arian parod amheus
