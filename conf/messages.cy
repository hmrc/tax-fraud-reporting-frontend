...
descriptionActivity.checkYourAnswersLabel = (W) Activity description (W)
...
typeBusiness.change.hidden = (W) Business type (W)
...
businessContactDetails.checkYourAnswersLabel = (W) Business contact details (W)
...
whenActivityHappen.betweenOneAndFive = (W) Between 1 and 5 years (W)
whenActivityHappen.betweenSixMonthAndOneYear= (W) Between 6 months and 1 year (W)
whenActivityHappen.withinSixMonth = (W) Within in the last 6 months (W)
whenActivityHappen.onlyOneOccasion = (W) Only on one occasion (W)
whenActivityHappen.notHappen = (W) It''s going to happen in the future (W)
...
activityTimePeriod.nextWeek = (W) In the next week (W)
activityTimePeriod.threeMonths = (W) In the next 3 months (W)
activityTimePeriod.later = (W) In the next year or later (W)
...
howManyPeopleKnow.hint = (W) Select the number of individuals that know about the activity in addition to yourself and individuals involved. (W)
howManyPeopleKnow.myselfAndIndividual = (W) Only myself and the individual(s) involved know (W)
howManyPeopleKnow.oneToFiveIndividuals = (W) 1 to 5 individuals (W)
howManyPeopleKnow.sixToTenIndividuals = (W) 6 to 10 individuals (W)
howManyPeopleKnow.moreThanTenIndividuals = (W) More than 10 individuals (W)
...
yourContactDetails.error.firstName.required = (W) Enter your first name. (W)
yourContactDetails.error.lastName.required = (W) Enter your last name. (W)
yourContactDetails.error.tel.required = (W) Enter your telephone number. (W)
yourContactDetails.error.memorableWord.required = (W) Enter your memorable word or phrase. (W)
yourContactDetails.error.tel.invalid = (W) Enter your telephone number, like 01632 960 001, 07700 900 982 or +44 808 157 0192 (W)
yourContactDetails.error.email.required = (W) Enter Email (W)
yourContactDetails.error.email.invalid = (W) Enter your email address in the correct format, like name@example.com (W)
yourContactDetails.error.firstName.length = (W) First names must be 255 characters or fewer. (W)
yourContactDetails.error.lastName.length = (W) Last names must be 255 characters or fewer. (W)
...
activitySourceOfInformation.reportedIndividuals = (W) Connection to the reported individual(s) (W)
activitySourceOfInformation.informationInLocalArea = (W) Information known in the local area (W)
activitySourceOfInformation.observedTheActivity = (W) Observed the activity (W)
activitySourceOfInformation.overheardTheActivity = (W) Overheard about the activity (W)
activitySourceOfInformation.speculatedThisActivity = (W) Speculated this activity may be happening (W)
activitySourceOfInformation.reportedByIndividual = (W) Told by reported individual(s) (W)
activitySourceOfInformation.byThirdPart = (W) Told by third party (W)
activitySourceOfInformation.other = (W) Other (W)
activitySourceOfInformation.otherValue = (W) Enter how you know the information (W)
activitySourceOfInformation.checkYourAnswersLabel = (W) How do you know this information? (W)
