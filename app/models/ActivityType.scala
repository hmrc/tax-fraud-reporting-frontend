...
// TODO tests
final case class ActivityType(code: String, activityName: String, activitySynonyms: Seq[String]) {
...
object ActivityType {
  ...
  def getActivityTypeByCode(code: String): Option[ActivityType] = list find (_.code == code)
  ...
  def getActivityByName(name: String): Option[ActivityType] = list find (_.activityName == name)
