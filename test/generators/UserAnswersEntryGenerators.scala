...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryIndividualAgeUserAnswersEntry: Arbitrary[(IndividualAgePage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[IndividualAgePage.type]
  ...
  implicit lazy val arbitraryDateFormatUserAnswersEntry: Arbitrary[(IndividualDateFormatPage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[IndividualDateFormatPage.type]
