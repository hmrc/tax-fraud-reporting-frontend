...
class IndividualAddressControllerSpec
  ...
  private val controller = app.injector.instanceOf[IndividualAddressController]

  "Individual's address page view" should {
    ...
    "load the page content" in {
      ...
      doc.getElementsByTag("h1").text() shouldBe messages("individualAddress.header")
    }
  }
