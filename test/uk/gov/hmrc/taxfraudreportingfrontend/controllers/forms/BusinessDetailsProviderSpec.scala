...
class BusinessDetailsProviderSpec extends OptionFieldBehaviours {

  val form = new BusinessDetailsProvider()()
  ...
  "form value" must {
    ...
    val fieldName   = "value"
    val requiredKey = "businessDetails.error.required"

    behave like optionsField[BusinessDetails](
      form,
      fieldName,
      validValues = BusinessDetails.values,
