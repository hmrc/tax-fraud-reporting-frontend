...
class ReportingTypeProviderSpec extends OptionFieldBehaviours {

  val form = new ReportingTypeProvider()()

  "form value" must {

    val fieldName   = "value"
    val requiredKey = "reportingType.error.required"

    behave like optionsField[ReportingType](
      form,
      fieldName,
      validValues = ReportingType.values,
