...
class BusinessContactControllerSpec extends BaseSpec with Matchers with MockitoSugar with OptionValues {

  val request: FakeRequest[AnyContentAsEmpty.type] =
    FakeRequest("GET", "/").withSession(SessionKeys.sessionId -> "fakesessionid")

  private val controller = application.injector.instanceOf[BusinessContactController]

  "business contact details page view" should {
