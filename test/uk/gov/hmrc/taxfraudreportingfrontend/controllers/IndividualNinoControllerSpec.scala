...
class IndividualNinoControllerSpec
  ...
  private val controller = app.injector.instanceOf[IndividualNinoController]

  "Individual's Nino page view" should {
    ...
    "load the page content" in {
      ...
      doc.getElementsByTag("h1").text() shouldBe messages("individualNino.header")
    }
  }
